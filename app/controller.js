...
exports.filterStudentbyName = function (req, res){

    studentModel.find({name: req.params.name},
...
// exports.getStudentOrderByName = function (req, res) {
//     studentModel.find( function (err, students) {
//         if (err) res.send(500, err.message);
//         res.status(200).jsonp(students);
//     }).sort({ name: 1 })
...
exports.getStudentOrderByName = function (req, res) {
    studentModel.find( function (err) {
        if (err) res.send(500, err.message);
    })  .sort({ name: 1 })
...
/** KO Why??? ***/
exports.getStudentBySubject = function (req, res){
    console.log(req.params.id);
    studentModel.find({'studies.name': req.params.id},
    //studentModel.find({studies : {$elemMatch: {_id: mongoose.Schema.Types.ObjectId(req.params.id)}}},
